...
import AutoDraftModal, { type GeneratedSection } from '@/components/auto-draft-modal'
import type {
  GrantsFullRow,
  GrantSection,
  SnippetRow,
...
export default function DraftsPage() {
  ...
  function selectGrant(g: GrantsFullRow) {
    ...
    setAutoDraftBanner(false)
  }

  function handleAutoDraftSectionComplete(title: string, content: string) {
    updateContent(title, content)
  }

  function handleAutoDraftComplete(generated: GeneratedSection[]) {
    if (generated.length > 0) setAutoDraftBanner(true)
      ...
      >
        {!selectedGrant ? (
          ...
          <>
            ...
            {autoDraftBanner && (
              <div
                className="shrink-0 flex items-center justify-between px-4 py-2 text-[11px]"
                style={{
              ...
              >
                <span>AI-generated draft — review and edit before submitting</span>
                <button
                  onClick={() => setAutoDraftBanner(false)}
            ...
            <div className="flex-1 flex flex-col min-h-0">
              {draftLoading ? (
                ...
                <>
                  ...
                  {showAutoDraftModal && selectedGrant && (
                    <AutoDraftModal
                      ...
                      onComplete={handleAutoDraftComplete}
                      onSectionComplete={handleAutoDraftSectionComplete}
                    />
                  )}
                </>
              )}
