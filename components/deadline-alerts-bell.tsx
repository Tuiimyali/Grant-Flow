...
export default function DeadlineAlertsBell({
  collapsed,
}: {
  collapsed: boolean
}) {
    ...
    <>
      ...
      >
        ...
        <span className="relative shrink-0">
          ...
          {badgeCount > 0 && (
            <span
              className="absolute -top-1.5 -right-1.5 flex items-center justify-center min-w-[16px] h-4 rounded-full text-white text-[9px] font-bold leading-none px-0.5"
        ...
        {!collapsed && (
          <span className="flex items-center gap-2 flex-1">
            ...
            {badgeCount > 0 && (
              <span
                className="inline-flex items-center justify-center rounded-full text-[10px] font-semibold px-1.5 py-0.5 leading-none"
                style={{
                  backgroundColor: 'rgba(196,90,90,0.2)',
                  color: 'var(--danger)',
                }}
              >
                {badgeCount}
