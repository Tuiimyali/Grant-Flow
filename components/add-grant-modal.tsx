          ...
          <div className="px-6 py-5 space-y-6 max-h-[70vh] overflow-y-auto">
            ...
            <div className="rounded-xl p-4 space-y-3" style={{ backgroundColor: 'var(--gold-bg)', border: '1px solid var(--gold-border)' }}>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg px-4 py-2 text-sm font-semibold disabled:opacity-50 transition-opacity shrink-0 btn-scale"
            ...
            <Section label="Application Sections">
              <div className="space-y-2">
                ...
                <AddRowBtn onClick={addSection} label="Add section" />
              </div>
            </Section>
