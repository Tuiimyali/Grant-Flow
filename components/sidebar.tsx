...
const NAV_ITEMS = [
  {
    ...
    href: '/dashboard',
    icon: (
      <svg viewBox="0 0 20 20" fill="currentColor" className="w-[17px] h-[17px] shrink-0">
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-[15px] h-[15px]" style={{ color: 'rgba(0,0,0,0.75)' }}>
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              style={
                active
                  ? { backgroundColor: 'var(--gold-bg)', color: 'var(--gold)', borderColor: 'var(--gold-border)' }
      ...
      >
        ...
        >
          <svg viewBox="0 0 20 20" fill="currentColor" className="w-[17px] h-[17px] shrink-0">
            ...
            <path fillRule="evenodd" d="M19 10a.75.75 0 0 0-.75-.75H8.704l1.048-1.028a.75.75 0 1 0-1.004-1.117l-2.5 2.25a.75.75 0 0 0 0 1.117l2.5 2.25a.75.75 0 1 0 1.004-1.117L8.704 10.75H18.25A.75.75 0 0 0 19 10Z" clipRule="evenodd" />
          </svg>
          {!collapsed && 'Sign out'}
        </button>
